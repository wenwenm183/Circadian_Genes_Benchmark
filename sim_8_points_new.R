...
# group1
# set.seed(101)
# s7.p24.t24.f2.new <- comb(n = 4, amount = c(rep(2000,3),6000), time_window = 23,
#                           freq = 1.5, type=c('cos','cos2','cos_peak','flat'))
# s7.p24.t48.f4.new <- comb(n = 4, amount = c(rep(2000,3),6000), time_window = 47,
#                           freq = 3, type=c('cos','cos2','cos_peak','flat'))
# s7.p24.t48.f8.new <- comb(n = 4, amount = c(rep(2000,3),6000), time_window = 47,
#                           freq = 6, type=c('cos','cos2','cos_peak','flat'))
# s7.p24.t24.f4.new <- comb(n = 4, amount = c(rep(2000,3),6000), time_window = 23,
#                           freq = 3, type=c('cos','cos2','cos_peak','flat'))
# runit(s7.p24.t24.f2.new, time = seq(0,22.5,1.5), freq = 1.5)
# runit(s7.p24.t48.f4.new, time = seq(0,45,3), freq = 3)
# runit(s7.p24.t48.f8.new, time = seq(0,42,6), freq = 6)
# runit(s7.p24.t24.f4.new, time = seq(0,21,3), freq = 3)
...
set.seed(102)
s7.nonsta.p24.t48.f8.new <- comb(n = 4, amount = c(rep(2000,3),6000), time_window = 23, freq = 3,
                                 type=c('cos_damp','trend_exp', 'trend_linear','linear'))
s7.asy.p24.t48.f8.new <- comb(n = 2, amount = c(6000,6000), time_window = 23, freq = 3,
                             type=c('saw_tooth','flat'))
runit(s7.nonsta.p24.t48.f8.new, time = seq(0,21,3), freq = 3)
runit(s7.asy.p24.t48.f8.new, time = seq(0,21,3), freq = 3)


# new.group3
set.seed(103)
s7.uneven.p24.t48.1.new <- comb(n = 4, amount = c(rep(2000,3),6000), time_window = 23,
                                freq = 3, type=c('cos','cos2','cos_peak','flat'))[,-4]
s7.uneven.p24.t48.2.new <- comb(n = 4, amount = c(rep(2000,3),6000), time_window = 23,
                                freq = 3, type=c('cos','cos2','cos_peak','flat'))[,-c(3,6)]
s7.uneven.p24.t48.4.new <- comb(n = 4, amount = c(rep(2000,3),6000), time_window = 23,
                                freq = 3, type=c('cos','cos2','cos_peak','flat'))[,-c(3,4,6,8)]
runit(object = s7.uneven.p24.t48.1.new,
      time = measure_sequence(colnames = colnames(s7.uneven.p24.t48.1.new), n = 8, freq = 3)$numbers,
      time2 = measure_sequence(colnames = colnames(s7.uneven.p24.t48.1.new), n = 8, freq = 3)$results)
runit(object = s7.uneven.p24.t48.2.new,
      time = measure_sequence(colnames = colnames(s7.uneven.p24.t48.2.new), n = 8, freq = 3)$numbers,
      time2 = measure_sequence(colnames = colnames(s7.uneven.p24.t48.2.new), n = 8, freq = 3)$results)
runit(object = s7.uneven.p24.t48.4.new,
      time = measure_sequence(colnames = colnames(s7.uneven.p24.t48.4.new), n = 8, freq = 3)$numbers,
      time2 = measure_sequence(colnames = colnames(s7.uneven.p24.t48.4.new), n = 8, freq = 3)$results)



# new.group4
set.seed(104)
s7.miss1.p24.t48 <- miss_ing2(dataset = comb(n = 4, amount = c(rep(2000,3),6000), time_window = 23,
                                   freq = 3, type=c('cos','cos2','cos_peak','flat')),
                              rate = 1, miss_col = c(3,5,6))
s7.miss7.p24.t48 <- miss_ing2(dataset = comb(n = 4, amount = c(rep(2000,3),6000), time_window = 23,
                                   freq = 3, type=c('cos','cos2','cos_peak','flat')),
                              rate = 5, miss_col = c(3,5,6))
s7.miss10.p24.t48 <- miss_ing2(dataset = comb(n = 4, amount = c(rep(2000,3),6000), time_window = 23,
                                    freq = 3, type=c('cos','cos2','cos_peak','flat')),
                               rate = 10, miss_col = c(3,5,6))

runit(s7.miss1.p24.t48, time = seq(0,21,3), freq = 3)
runit(s7.miss7.p24.t48, time = seq(0,21,3), freq = 3)
runit(s7.miss10.p24.t48, time = seq(0,21,3), freq = 3)


# new.group5
# set.seed(105)
# s7.r2.p24.t48.new <- comb(n = 4, amount = c(rep(2000,3),6000), time_window = 95,
#                           freq = 6, type=c('cos','cos2','cos_peak','flat'))
# colnames(s7.r2.p24.t48.new)[-1] <- paste(rep(paste('CT', seq(0,42,6), sep = ''),2), paste('_',c(sapply(seq(1,2,1),function(x){rep(x,8)})), sep=''), sep = '')
# 
# s7.r2.p24.t24.new <- comb(n = 4, amount = c(rep(2000,3),6000), time_window = 47,
#                           freq = 6, type=c('cos','cos2','cos_peak','flat'))
# colnames(s7.r2.p24.t24.new)[-1] <- paste(rep(paste('CT', seq(0,18,6), sep = ''),2), paste('_',c(sapply(seq(1,2,1),function(x){rep(x,4)})), sep=''), sep = '')
# 
# runit(s7.r2.p24.t48.new, time = rep(seq(0,42,6),2), freq = 6)
# runit(s7.r2.p24.t24.new, time = rep(seq(0,18,6),2), freq = 6)



# new.group6
set.seed(106)
s7.snr0.5.p24.t48.new <- comb(n = 2, amount = c(6000,6000), time_window = 23, freq = 3,
                              type=c('SNR_cos','flat'), SNR = 0.5)
s7.snr1.p24.t48.new <- comb(n = 2, amount = c(6000,6000), time_window = 23, freq = 3,
                            type=c('SNR_cos','flat'), SNR = 1)
s7.snr2.p24.t48.new <- comb(n = 2, amount = c(6000,6000), time_window = 23, freq = 3,
                            type=c('SNR_cos','flat'), SNR = 2)
s7.snr3.p24.t48.new <- comb(n = 2, amount = c(6000,6000), time_window = 23, freq = 3,
                            type=c('SNR_cos','flat'), SNR = 3)

runit(s7.snr0.5.p24.t48.new, time = seq(0,21,3), freq = 3)
runit(s7.snr1.p24.t48.new, time = seq(0,21,3), freq = 3)
runit(s7.snr2.p24.t48.new, time = seq(0,21,3), freq = 3)
runit(s7.snr3.p24.t48.new, time = seq(0,21,3), freq = 3)
