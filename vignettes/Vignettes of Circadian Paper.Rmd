...
![](figures/Methods.png){ width=75% }


Here we have constructed two flow charts with regards to which method(s) perform well with high/low noise, and with the presence or absense of uneven sampling, replicates, and missing values. 

Below is the flow chart for datasets with low sampling resolution.
![](figures/low.png)
This is the flow chart for datasets with high sampling resolution.
![](figures/high.png)
