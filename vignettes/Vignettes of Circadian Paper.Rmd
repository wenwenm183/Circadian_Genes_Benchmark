...
![Method Summary](./figures/data_summary.png)

![Pros and Cons of the Methods](./figures/P&C.png)

![Method Selection for Datasets with Low-sampling Resolution](./figures/Tree1.png)

![Method Selection for Datasets with High-sampling Resolution](./figures/Tree2.png)
